...
export const POSFeature = () => {
  return (
    <DevicePairingFlow type="pos">
      {({ organizationId }) => (
        <POSContent key={organizationId} orgId={organizationId || ""} />
      )}
    </DevicePairingFlow>
  );
};
        ...
        <AnimatePresence mode="wait">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    selectedCategoryId === null
                      ? "bg-primary text-black shadow-[0_0_20px_rgba(var(--primary),0.4)]"
          ...
          {activeTab === "settings" && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="flex-1 p-12 max-w-2xl mx-auto space-y-12"
            >
                ...
                <div className="bg-zinc-900/50 border border-zinc-800 p-6 rounded-3xl flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-zinc-500 text-xs">
                      Sign out user after each transaction
                    </div>
                  </div>
                  <button
                    ...
                    className={cn(
                      ...
                      autoLogout
                        ? "bg-primary/20 border-primary justify-end"
            ...
            {paymentStatus === "idle" && (
              <>
                ...
                <div className="grid grid-cols-2 gap-4 w-full">
                  <Button
                    className="h-20 rounded-[2rem] bg-zinc-900 border-zinc-800 hover:bg-zinc-800 font-black uppercase tracking-widest"
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {["Rare", "Medium", "Well Done"].map((m) => (
                    <button
                      key={m}
                      className="h-14 rounded-2xl bg-zinc-900 border border-zinc-800 text-xs font-bold text-zinc-400 hover:border-primary hover:text-primary transition-all uppercase tracking-widest"
                    >
                      {m}
                    </button>
                  ))}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <button
                      key={m}
                      className="h-14 px-6 rounded-2xl bg-zinc-900 border border-zinc-800 text-xs font-bold text-zinc-400 hover:border-primary hover:text-primary transition-all flex items-center justify-between uppercase tracking-widest"
                    >
                      {m}
