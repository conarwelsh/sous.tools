...
import { ChefHat, Apple, ArrowRight } from "lucide-react";
import { useRouter } from "next/navigation";

export function CulinaryDashboardView() {
  const router = useRouter();

  const sections = [
    {
      title: "Recipes",
      description: "The intellectual property of your kitchen.",
      icon: ChefHat,
    ...
    {
      title: "Ingredients",
      description: "Manage raw materials and pantry definitions.",
      icon: Apple,
