...
export const ImageSelector: React.FC<ImageSelectorProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onCancel()}>
      <DialogContent className="max-w-4xl h-[70vh] flex flex-col p-0 border-border bg-background">
        ...
        {/* Tabs */}
        <View className="flex-row border-b border-border px-8">
          {[
        ...
        <View className="flex-1 overflow-hidden">
          ...
          {activeTab === "upload" && (
            <View className="flex-1 items-center justify-center p-12">
              <div className="w-full max-w-md p-12 border-2 border-dashed border-border rounded-3xl bg-muted/20 flex flex-col items-center text-center">
                {isUploading ? (
                  <>
