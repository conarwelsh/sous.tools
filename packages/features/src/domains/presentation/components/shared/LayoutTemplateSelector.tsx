              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredTemplates.map((t) => (
                  ...
                  >
                    ...
                    <Text className="text-foreground font-black uppercase text-xs mb-1 truncate">
                      {t.name}
                    </Text>
                    <div className="flex flex-row flex-wrap gap-1">
                      {t.isSystem && (
                        <div className="px-1.5 py-0.5 bg-primary/10 border border-primary/20 rounded text-[6px] font-black text-primary uppercase">
                          System
                        </div>
                      )}
                      {(t.tags || []).map((tag) => (
                        <div
                          key={tag}
                          className="px-1.5 py-0.5 bg-muted rounded text-[6px] font-black text-muted-foreground uppercase"
                        >
                          {tag}
                        </div>
                      ))}
