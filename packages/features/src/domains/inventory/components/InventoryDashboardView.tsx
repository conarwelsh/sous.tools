...
export function InventoryDashboardView() {
  ...
  const sections = [
    {
      title: "Stock Ledger",
      description: "Real-time tracking of theoretical vs. physical stock.",
      icon: Package,
    ...
    {
      title: "Wastage",
      description: "Record and analyze operational loss and spoilage.",
      icon: Trash2,
          ...
          >
            <Card className="p-8 h-full bg-card border-border hover:border-primary/50 transition-all group flex flex-col">
              <View className="flex-row justify-between items-start mb-6">
                ...
                <Text className="text-muted-foreground/40 font-mono text-[10px] uppercase tracking-widest">
                  {s.stats}
                </Text>
              </View>
