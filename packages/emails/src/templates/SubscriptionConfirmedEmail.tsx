...
export const SubscriptionConfirmedEmail = ({
  ...
  <BaseLayout preview={`Welcome to the ${planName} plan, Chef!`}>
    ...
    <Text className="text-zinc-600 text-sm mb-6">
      Hello {userName}, your subscription for **{orgName}** is now active. You
      have full access to the **{planName}** features.
    </Text>

    <Section className="bg-zinc-50 p-6 rounded-2xl border border-zinc-100 mb-8">
      <Text className="text-xs font-bold text-zinc-900 mb-2 uppercase">
      ...
      <Row className="py-2">
        ...
        <Column align="right">
          <Text className="text-xs font-black text-zinc-900 m-0">
            {orgName}
          </Text>
        </Column>
      </Row>
      ...
      <Row className="py-2">
        ...
        <Column align="right">
          <Text className="text-xs font-black text-emerald-600 m-0 uppercase">
            Active
          </Text>
        </Column>
      </Row>
