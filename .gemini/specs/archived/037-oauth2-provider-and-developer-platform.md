...
3.  **Consent**: User sees a prompt: _"App X wants to access your POS Data. Allow?"_
...
- **Format**: Standard JWT.
- **Payload**: Includes a `scopes` array containing the _intersection_ of the User's allowed scopes and the App's requested scopes.
