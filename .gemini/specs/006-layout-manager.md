...
3.  **Footer:** Drag in a "Container" *below* the Main Body. Set `height: auto` (or fixed). Set `display: flex; justify-content: space-between`.
    ...
    "children": [
      {
        ...
        "children": [
          { "type": "slot", "id": "slot_main_left", "name": "Main Left", "styles": { "flex": "1", "overflow": "auto" } },
          { "type": "slot", "id": "slot_main_right", "name": "Main Right", "styles": { "flex": "1", "overflow": "auto" } }
        ]
      },
      {
        "type": "container", // Footer
        "styles": { "height": "auto", "display": "flex", "justifyContent": "space-between" },
        "children": [
      ...
      {
        "type": "fixed", // Logo
        "styles": { "position": "absolute", "top": "20px", "right": "20px", "width": "100px", "height": "100px" },
