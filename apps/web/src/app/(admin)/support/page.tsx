...
import { View, Text, Card, CardHeader, CardTitle, CardDescription, CardContent } from "@sous/ui";
      ...
      <View className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <View className="lg:col-span-2">
          <Card className="border-border/50 shadow-xl shadow-primary/5 rounded-[2rem] overflow-hidden">
            <CardHeader className="bg-muted/30 border-b border-border/50 p-8">
              <CardTitle className="text-xl font-bold uppercase tracking-tight">Submit a Request</CardTitle>
              <CardDescription>
        ...
        <View className="space-y-6">
          <Card className="border-border/50 rounded-2xl">
            <CardHeader>
              <CardTitle className="text-sm font-bold uppercase tracking-widest text-primary">Documentation</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <Text className="text-sm">
                Looking for guides or API references? Our documentation hub has everything you need.
              </Text>
              <a 
                href="/docs" 
          ...
          <Card className="border-border/50 rounded-2xl">
            ...
            <CardContent className="space-y-2">
              <View className="flex flex-row items-center gap-2">
                ...
                <Text className="font-medium text-sm">All Systems Operational</Text>
              </View>
